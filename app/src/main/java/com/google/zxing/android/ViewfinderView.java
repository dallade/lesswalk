...
public final class ViewfinderView extends View
{
	...
	public void onDraw(Canvas canvas)
	{
		...
		Rect frame = cameraManager.getFramingRect(getWidth(), getHeight());
		Rect previewFrame = cameraManager.getFramingRectInPreview(getWidth(), getHeight());
		...
		else
		{
			...
			canvas.drawRect(frame.left + 2, middle - 1 + lineOffset, frame.right - 1, middle + 2 + lineOffset, paint);
			
			lineOffset += 30.0f;
			if(lineOffset > frame.height()/2.0f) lineOffset = -frame.height()/2.0f;
